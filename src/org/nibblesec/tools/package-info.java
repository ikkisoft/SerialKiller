 ...
 * <b>SerialKiller</b><br>
 *
 * Copyright (c) 2015-2016 Luca Carettoni<br><br>
 *
 * SerialKiller is an easy-to-use look-ahead Java deserialization library 
 * to secure application from untrusted input.<br> When Java serialization is
 ...
 * a combination of blacklisting/whitelisting to secure your application.<br><br>
 *
